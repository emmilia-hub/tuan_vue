...
.trigle {
  ...
  .back_img1 {
    ...
    background-size: 62%;
    animation: trigle_move 6s linear infinite;
    -webkit-animation: trigle_move 6s linear infinite;
  }
  .back_img2 {
    position: absolute;
    top: 190px;
    ...
    background-size: 39%;
    animation: trigle_move1 6s linear infinite;
    -webkit-animation: trigle_move1 6s linear infinite;
  }
  .back_img3 {
    position: absolute;
    top: 247px;
  ...
  .first {
    ...
    animation: trigle_down1 0.2s linear;
    -webkit-animation: trigle_down1 0.2s linear; 
    li {
      width: 100%;
      height: 100%;
      line-height: 200px;
  ...
  .second {
    ...
    perspective: 2000px;
    perspective-origin: 50% 100%;
    animation: trigle_down2 1s linear;
    -webkit-animation: trigle_down2 1s linear;
    li {
      width: 100%;
      height: 100%;
      position: absolute;
  ...
  .third {
    ...
    perspective: 2000px;
    perspective-origin: 50% 100%;
    animation: trigle_down3 2s linear;
    -webkit-animation: trigle_down3 2s linear;
    li {
      width: 100%;
      height: 100%;
      position: absolute;
  ...
  .four {
    ...
    perspective: 2000px;
    perspective-origin: 50% 100%;
    animation: trigle_down4 3s linear;
    -webkit-animation: trigle_down4 3s linear;
    li {
      width: 100%;
      height: 100%;
      position: absolute;
  ...
  .detail {
    ...
    .detail_txt {
      ...
      &.detail_txt1 {
        animation : opacity_path 2s linear;
        -webkit-animation: opacity_path 2s linear; 
      }
      &.detail_txt2 {
        animation : opacity_path2 3s linear;
        -webkit-animation: opacity_path2 3s linear;
        float: right; 
      }
      &.detail_txt3 {
        animation : opacity_path3 4s linear;
        -webkit-animation: opacity_path3 4s linear; 
      }
      &.detail_txt4 {
        animation : opacity_path4 5s linear;
        -webkit-animation: opacity_path4 5s linear;
        float: right; 
      }
      .precent_txt {
        width: 50px;
  ...
  .arrow_contain {
    ...
    display: inline-block;
    &.arrow_contain1 {
      animation : clip_line 1s linear;
      -webkit-animation: clip_line 1s linear;
      float: right;
    }
    &.arrow_contain2 {
      animation : clip_line2 2s linear;
      -webkit-animation: clip_line2 2s linear;
      float: left; 
    }
    &.arrow_contain3 {
      animation : clip_line3 3s linear;
      -webkit-animation: clip_line3 3s linear; 
      float: right;
    }
    &.arrow_contain4 {
      animation : clip_line4 4s linear;
      -webkit-animation: clip_line4 4s linear;
      float: left;
    }
    .arrow {
      &.arrow_1 {
